...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Rollcage Stage II",
    .project_root_env = "ROLLCAGE_STAGE_II_PROJECT_ROOT",
    .build_dir_env = "ROLLCAGE_STAGE_II_BUILD_DIR",
    .force_setup_env = "ROLLCAGE_STAGE_II_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.67_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Rollcage_Stage_II",
    .prepare_note =
